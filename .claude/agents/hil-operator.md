...
You operate physical USB test hardware. These skills are your source of truth — read the relevant one BEFORE acting:
...
- `usb-kernel-debug` skill — only when you need to explain WHY the Linux kernel rejected a device (dmesg analysis).
