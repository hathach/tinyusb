...
|              |         | 51u               | ✔      | ✖    | ✖         | lpc_ip3511             |                                             |
|              |         +-------------------+--------+------+-----------+------------------------+---------------------------------------------+
|              |         | 54                | ⚠      | ⚠    | ✔         | lpc_ip3511, lpc_ip3516 | :ref:`NRND, read errata <LPC54600 Issues>`  |
|              |         +-------------------+--------+------+-----------+------------------------+---------------------------------------------+
...
+--------------+-----------------------------+--------+------+-----------+------------------------+---------------------------------------------+
| WCH          | CH32F20x                    | ⚠      |      | ✔         | ch32_usbhs             | :ref:`ISO data loss <WCH CH32X Issues>`     |
|              +-----------------------------+--------+------+-----------+------------------------+---------------------------------------------+
|              | CH32V20x                    | ⚠      |      | ✖         | stm32_fsdev/ch32_usbfs | :ref:`ISO data loss <WCH CH32X Issues>`     |
|              +-----------------------------+--------+------+-----------+------------------------+---------------------------------------------+
|              | CH32V305, CH32V307          | ⚠      |      | ✔         | ch32_usbfs/hs          | :ref:`ISO data loss <WCH CH32X Issues>`     |
+--------------+-----------------------------+--------+------+-----------+------------------------+---------------------------------------------+
