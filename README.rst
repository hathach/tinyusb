...
|              |         | 51u               | ✔      | ✖    | ✖         | lpc_ip3511             |                                                                                         |
|              |         +-------------------+--------+------+-----------+------------------------+-----------------------------------------------------------------------------------------+
|              |         | 54                | ⚠      | ⚠    | ✔         | lpc_ip3511, lpc_ip3516 | `NRND, see device issues <docs/reference/device_issues.rst#nxp-lpc54600>`_              |
|              |         +-------------------+--------+------+-----------+------------------------+-----------------------------------------------------------------------------------------+
...
+--------------+-----------------------------+--------+------+-----------+------------------------+-----------------------------------------------------------------------------------------+
| WCH          | CH32F20x                    | ⚠      |      | ✔         | ch32_usbhs             | `ISO data loss <docs/reference/device_issues.rst#wch-ch32f20x-ch32v20x-ch32v30x>`_      |
|              +-----------------------------+--------+------+-----------+------------------------+-----------------------------------------------------------------------------------------+
|              | CH32V20x                    | ⚠      |      | ✖         | stm32_fsdev/ch32_usbfs | `ISO data loss <docs/reference/device_issues.rst#wch-ch32f20x-ch32v20x-ch32v30x>`_      |
|              +-----------------------------+--------+------+-----------+------------------------+-----------------------------------------------------------------------------------------+
|              | CH32V305, CH32V307          | ⚠      |      | ✔         | ch32_usbfs/hs          | `ISO data loss <docs/reference/device_issues.rst#wch-ch32f20x-ch32v20x-ch32v30x>`_      |
+--------------+-----------------------------+--------+------+-----------+------------------------+-----------------------------------------------------------------------------------------+
