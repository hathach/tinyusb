...
//    esp_usb_phy_t *phy;
    ...
    *
    * @param[in] usb_handle: handle of Ethernet driver
 ...
 *
 */
#define USB_DEFAULT_CONFIG(addr)   \
    {                                    \
        .macaddr[0] = addr[0],           \
        .macaddr[1] = addr[1],           \
        .macaddr[2] = addr[2],           \
...
*
* @return
*       - ESP_OK: install esp_usb driver successfully
*       - ESP_ERR_INVALID_ARG: install esp_usb driver failed because of some invalid argument
*       - ESP_ERR_NO_MEM: install esp_usb driver failed because there's no memory for driver
*       - ESP_FAIL: install esp_usb driver failed because some other error occurred
*/
...
*
* @return
*       - ESP_OK: uninstall esp_usb driver successfully
*       - ESP_ERR_INVALID_ARG: uninstall esp_usb driver failed because of some invalid argument
*       - ESP_ERR_INVALID_STATE: uninstall esp_usb driver failed because it has more than one reference
*       - ESP_FAIL: uninstall esp_usb driver failed because some other error occurred
*/
...
*
* @return
*       - ESP_OK: start esp_usb driver successfully
*       - ESP_ERR_INVALID_ARG: start esp_usb driver failed because of some invalid argument
*       - ESP_ERR_INVALID_STATE: start esp_usb driver failed because driver has started already
*       - ESP_FAIL: start esp_usb driver failed because some other error occurred
*/
...
*
* @note This function does the oppsite operation of `esp_usb_start`.
*
* @param[in] hdl handle of Ethernet driver
* @return
*       - ESP_OK: stop esp_usb driver successfully
*       - ESP_ERR_INVALID_ARG: stop esp_usb driver failed because of some invalid argument
*       - ESP_ERR_INVALID_STATE: stop esp_usb driver failed because driver has not started yet
*       - ESP_FAIL: stop esp_usb driver failed because some other error occurred
*/
...
*       Instead, users should register input callback with ``esp_usb_update_input_path``.
*
* @return
...
*/
esp_err_t esp_usb_receive(esp_usb_handle_t hdl, uint8_t *buf, uint32_t *length) __attribute__((deprecated("Ethernet driver is interrupt driven only, please register input callback with esp_usb_update_input_path")));
