...
# Quiesce the SDI debug module after programming: clear dcsr.ebreak* (a TU_ASSERT would otherwise
# halt the core silently) and deactivate the DM, which sporadically corrupts core registers while
# it stays active during USB operation (hw-measured 2026-08-11: 10/12 HIL suite failures, board
# dead until the next flash). OPENOCD_OPTION2 runs in the SAME openocd invocation as program+reset
# on purpose - a second attach re-activates the DM on the now-running firmware.
set(OPENOCD_OPTION2 "-c \"halt\" -c \"reg dcsr 0x40000003\" -c \"resume\" -c \"riscv dmi_write 0x10 0\"")
