...
typedef enum
{
  AUDIO_TERM_TYPE_BI_DIRECTORAL_UNDEFINED = 0x0400,
  AUDIO_TERM_TYPE_BI_DIRECTORAL_HEADSET_HAND_HELD = 0x0401,
  AUDIO_TERM_TYPE_BI_DIRECTORAL_HEADSET_MOUNTED = 0x0402,
  AUDIO_TERM_TYPE_BI_DIRECTORAL_SPEAKERPHONE = 0x0403,
  AUDIO_TERM_TYPE_BI_DIRECTORAL_SPEAKERPHONE_ECHO_SUPPRESS = 0x0404,
  AUDIO_TERM_TYPE_BI_DIRECTORAL_SPEAKERPHONE_ECHO_CANCLE = 0x0405,
} audio_terminal_bi_directorial_type_t;
...
typedef enum
{
  ...
  AUDIO_TERM_TYPE_EMBEDDED_SATELITE_RECEIVER_AUDIO = 0x070D,
