...
enum {
  ...
  HID_USAGE_DESKTOP_DOCKABLE_DEVICE_DISPLAY_OCCULSION          = 0xD5, // CL
...
enum {
  ...
  HID_USAGE_TELEPHONY_PHONE_SETINGS_KEY           = 0x00C2, // Sel
  // C3-EF Reserved
  ...
  HID_USAGE_TELEPHONY_REDIABLE_PHONE_NUMBER       = 0x00F5, // OOC
  // F6-F7 Reserved
